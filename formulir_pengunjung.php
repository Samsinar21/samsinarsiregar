...
<head>
    ...
    <title>Formulir Data Pengunjung Perpustakaan Sederhana Samsinar Siregar</title>
    <style>
        body {
        ...
        input[type="submit"] {
            background-color:rgb(80, 15, 201);
            color: white;
            border: none;
            padding: 10px 15px;
            border-radius: 4px;
...
<h2>Formulir Data Pengunjung Perpustakaan Sederhana Samsinar Siregar</h2>
